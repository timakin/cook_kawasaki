...
var gurunavi_url = GURUNAVI_ORIGIN_URL + "keyid=" + GURUNAVI_ACCESS_KEY + '&latitude=35.65898718965676&longitude=139.70277630100122&range=4&freeword=' + encodeURIComponent(BUILDING_NAME)


exports.get_gnavi_page_max = function() {
  return new Promise(function(resolve, reject) {
    request(gurunavi_url, function(error, response,body) {
      if (error) {
        reject(err);
      } else {
...
exports.get_gnavi_data = function(page_max) {
  return new Promise(function(resolve, reject) {
    var i;
    var promise_array = [];
    for(i = 0; i < page_max; i++) {
      var url_per_page = gurunavi_url + '&offset_page=' + i;
